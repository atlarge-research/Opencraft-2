        ...
        protected override void OnUpdate()
        {
            ...
            Entities.ForEach((Entity entity, in GhostAuthoringComponentBakingData ghostAuthoringBakingData) =>
            {
                ...
                if (!isPrefab && isInSubscene && activeInScene)
                {
                    ...
                    //authoring
                    // FIX https://forum.unity.com/threads/1-0-0-pre-65-short-guide-for-creating-fully-working-builds.1419512/
                    //var archetypeStableHash = EntityManager.GetStorageInfo(entity).Chunk.Archetype.StableHash;
                    //hashData.Add(archetypeStableHash);
                    var ghostType = ghostAuthoringBakingData.GhostType;
                    hashData.Add(ghostType.guid0);
                    hashData.Add(ghostType.guid1);
                    hashData.Add(ghostType.guid2);
                    hashData.Add(ghostType.guid3);
                    unsafe
                    {
