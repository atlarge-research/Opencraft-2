...
inline void InitializeSimpleLitSurfaceData(float3 uv, out SurfaceData outSurfaceData)
{
    outSurfaceData = (SurfaceData)0;

    half4 albedoAlpha = half4(UNITY_SAMPLE_TEX2DARRAY(_ColourTextures, uv).rgb, 1.0) * _BaseColor;
